...
var (
	NotBondedPoolAccountID = types.NewAccountIDFromName(types.MustName(NotBondedPoolName))
	BondedPoolAccountID    = types.NewAccountIDFromName(types.MustName(BondedPoolName))
)
