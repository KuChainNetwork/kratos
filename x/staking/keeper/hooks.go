...
func (k Keeper) AfterValidatorCreated(ctx sdk.Context, valAddr AccountID) {
	if k.hooks != nil {
...
func (k Keeper) BeforeValidatorModified(ctx sdk.Context, valAddr AccountID) {
	if k.hooks != nil {
...
func (k Keeper) AfterValidatorRemoved(ctx sdk.Context, consAddr sdk.ConsAddress, valAddr AccountID) {
	if k.hooks != nil {
...
func (k Keeper) AfterValidatorBonded(ctx sdk.Context, consAddr sdk.ConsAddress, valAddr AccountID) {
	if k.hooks != nil {
...
func (k Keeper) AfterValidatorBeginUnbonding(ctx sdk.Context, consAddr sdk.ConsAddress, valAddr AccountID) {
	if k.hooks != nil {
...
func (k Keeper) BeforeDelegationCreated(ctx sdk.Context, delAddr AccountID, valAddr AccountID) {
	if k.hooks != nil {
...
func (k Keeper) BeforeDelegationSharesModified(ctx sdk.Context, delAddr AccountID, valAddr AccountID) {
	if k.hooks != nil {
...
func (k Keeper) BeforeDelegationRemoved(ctx sdk.Context, delAddr AccountID, valAddr AccountID) {
	if k.hooks != nil {
...
func (k Keeper) AfterDelegationModified(ctx sdk.Context, delAddr AccountID, valAddr AccountID) {
	if k.hooks != nil {
...
func (k Keeper) BeforeValidatorSlashed(ctx sdk.Context, valAddr AccountID, fraction sdk.Dec) {
	if k.hooks != nil {
