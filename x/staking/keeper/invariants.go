...
func ModuleAccountInvariants(k Keeper) sdk.Invariant {
	return func(ctx sdk.Context) (string, bool) {
		...
		poolBonded := k.bankKeeper.GetCoinPowerByDenomd(ctx, bondedPool.GetID(), bondDenom)
		poolNotBonded := k.bankKeeper.GetCoinPowerByDenomd(ctx, notBondedPool.GetID(), bondDenom)
