...
// GenTallyParamsQuorum randomized TallyParamsQuorum
func GenTallyParamsEmergency(r *rand.Rand) sdk.Dec {
	return sdk.NewDecWithPrec(int64(simulation.RandIntBetween(r, 667, 800)), 3)
}
...
func RandomizedGenState(simState *module.SimulationState) {
	...
	var emergency sdk.Dec
	simState.AppParams.GetOrGenerate(
		simState.Cdc, TallyParamsVeto, &emergency, simState.Rand,
		func(r *rand.Rand) { emergency = GenTallyParamsEmergency(r) },
	)

	var punishPeriod time.Duration
	simState.AppParams.GetOrGenerate(
		simState.Cdc, VotingParamsVotingPeriod, &punishPeriod, simState.Rand,
		func(r *rand.Rand) { votingPeriod = GenVotingParamsVotingPeriod(r) },
	)
